...
<div id="main" role="main" class="l_top_div">
    <div class="l_top_tlt">developer login</div>
    <div class="l_alert_cnt"><?php if ( isset($alert) ) echo $alert;?></div>
    <form id="checkout-form" class="smart-form" novalidate="novalidate" method="post" action="<?= base_url();?>front/developer_login_confirm">
        <fieldset>
            <div class="row">
