...
<div id="main" role="main" class="l_top_div">
    <div class="l_top_tlt l_top_2fa">2-Factor Authentication</div>
    <div class="l_alert_cnt"><?php if ( isset($alert) ) echo $alert;?></div>
    <form id="checkout-form" class="smart-form" novalidate="novalidate" method="post" action="<?= base_url();?>admin/confirm_2fa">
        <fieldset>
            <div class="row">
                <section class="col col-10 l_sec">
                    <label class="input"> <i class="icon-prepend fa fa-key"></i>
                        <input type="text" name="token" placeholder="2FA Code">
                    </label>
                </section>
            </div>
        </fieldset>
        <footer>
            <button type="submit" name="submit" class="btn btn-primary l_login_btn">
                login
            </button>
        </footer>
    </form>
